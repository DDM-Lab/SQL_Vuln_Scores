...
def init_dbs():
    ...
    c.execute("INSERT OR IGNORE INTO flags VALUES (1, 'picoCTF{SQL_UNION_3XPLO1T_4774CK}')")
    conn.commit()
    conn.close()
    ...
    c.execute("INSERT OR IGNORE INTO hidden_flags VALUES (1, 'picoCTF{SQL_UNION_3XPLO1T_4774CK}')")
    conn.commit()
    conn.close()
    ...
    c.execute("INSERT OR IGNORE INTO library_secrets VALUES (1, 'picoCTF{SQL_UNION_3XPLO1T_4774CK}')")
    conn.commit()
    conn.close()
